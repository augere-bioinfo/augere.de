...
`r self` implements [**augere** pipelines](https://github.com/augere-bioinfo) for differential expression (DE) analysis of RNA-seq data based on `r BiocStyle::Biocpkg("edgeR")` and `voom()`.
