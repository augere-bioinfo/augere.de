...
```{r}
reloaded <- augere.core::readResult(file.path(output.dir, "results", "de-1"))
...
res.sets <- runEdgeR(
    se,
    group="cell", 
    comparisons=c("N052611", "N061011", "N080611", NA, "N61311"),
...
```{r}
runEdgeR(
    augere.core::wrapInput(se, commands="augere.de::loadExampleDataset()"),
    group="dex",
    comparisons=c("trt", "untrt"),
    output.dir=output.dry.dir,
    dry.run=TRUE
...
str(augere.core::readResult(file.path(output.custom.dir, "results", "de-1"))$metadata)
```
